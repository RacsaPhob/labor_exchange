...
class HTTPSyncIntegrationContainer(containers.DeclarativeContainer):
    ...
    http_sync_repository = providers.Factory(http_repository.SyncHTTPRepository, http_sync_session)
    http_sync_uow = providers.Factory(http_uow.SyncHTTPUOW, http_sync_repository)
...
class HTTPAsyncIntegrationContainer(containers.DeclarativeContainer):
    ...
    http_async_uow = providers.Factory(http_uow.AsyncHTTPUOW, http_async_repository)
